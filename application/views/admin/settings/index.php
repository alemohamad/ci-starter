        ...
        <section id="list-section">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-inline"><a href="http://www.gravatar.com/" target="_blank">Gravatar</a> account.</span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-block">If you don't want to change the password, leave the password fields empty.</span>
                </div>
            </div>
